...
4. Choose your track:
   - **Java** → start with [workshop/java/exercise-01-setup-and-install.md](workshop/java/exercise-01-setup-and-install.md)
   - **.NET** → start with [workshop/dotnet/exercise-01-setup-and-assess.md](workshop/dotnet/exercise-01-setup-and-assess.md)
